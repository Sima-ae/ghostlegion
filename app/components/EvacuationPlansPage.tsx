    ...
    <div className="bg-gray-50 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Evacuation Plans</h1>
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            {Object.keys(evacuationRoutes).map((region) => (
              <button
                ...
                className={`px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium transition-colors ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {evacuationRoutes[selectedRegion as keyof typeof evacuationRoutes].routes.map((route) => (
            <div key={route.id} className="bg-white rounded-lg shadow-sm border p-4 sm:p-6 relative">
